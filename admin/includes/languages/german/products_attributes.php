...
const TABLE_HEADING_OPT_PRICE_PREFIX = 'Vorzeichen (+/-)';
const TABLE_HEADING_ACTION = 'Aktion';
const TABLE_HEADING_DOWNLOAD = 'Downloadbare Produkte:';
const TABLE_TEXT_FILENAME = 'Dateiname:';
const TABLE_TEXT_MAX_DAYS = 'Zeitspanne:';
const TABLE_TEXT_MAX_COUNT = 'Maximale Anzahl zum Herunterladen:';
