...
define('TEXT_INFO_TAX_RATE_PRIORITY', 'Steuersätze auf die gleiche Priorität setzten, andere werden zusammengesetzt.<br><br>Priorität:');
define('TEXT_INFO_RATE_DESCRIPTION', 'Beschreibung:<br>%s');
