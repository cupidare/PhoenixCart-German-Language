...
const TEXT_SPECIALS_PRODUCT = 'Produkt';
const TEXT_SPECIALS_SPECIAL_PRICE = 'Angebotspreis';
const TEXT_SPECIALS_EXPIRES_DATE = 'Gültig bis';
const TEXT_SPECIALS_PRICE_TIP = <<<'EOT'
<p class="lead">Bitte beachten:</p>
<dl class="row">
<dt class="col-sm-3">Prozentangaben</dt><dd class="col-sm-9">Sie können Prozentangaben zum Originalpreis angeben: z.B.: <strong>20%</strong></dd>
<dt class="col-sm-3">Dezimalzeichen</dt><dd class="col-sm-9">Wenn Sie einen neuen Preis angeben, muss er mit <strong>.</strong> (Dezimal-Punkt) angegeben werden, z.B.: <strong>49.99</strong></dd>
<dt class="col-sm-3">Gültig bis</dt><dd class="col-sm-9">Lassen Sie das Feld frei, wenn das Angebot nicht ablaufen soll.</dd>
</dl>
EOT;
