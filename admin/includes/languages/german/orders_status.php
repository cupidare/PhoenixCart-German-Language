...
define('ERROR_REMOVE_DEFAULT_ORDER_STATUS', '<strong>Error:</strong> Der Standard-Bestellstatus kann nicht gelöscht werden. Bitte definieren Sie einen neuen Standard-Bestellstatus und wiederholen Sie den Vorgang.');
define('ERROR_STATUS_USED_IN_ORDERS', '<strong>Error:</strong> Dieser Bestellstatus wird zur Zeit noch bei den Bestellungen verwendet.');
define('ERROR_STATUS_USED_IN_HISTORY', '<strong>Error:</strong> Dieser Bestellstatus wird zur Zeit noch in der Bestellhistorie verwendet.');
