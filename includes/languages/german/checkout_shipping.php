...
define('TEXT_CHOOSE_SHIPPING_DESTINATION', 'Bitte wählen Sie aus Ihrem Adressbuch die gewünschte Versandadresse für Ihre Bestellung aus.');
...
define('ERROR_NO_SHIPPING_AVAILABLE_TO_SHIPPING_ADDRESS','Fehler - An diese Adresse ist keine Zustellung möglich', 'Zustellung ist derzeit an die gewählte Adresse nicht möglich. Bitte wählen Sie eine andere Zustelladresse.'); 
