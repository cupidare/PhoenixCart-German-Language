...
*/
  ...
  define('MODULE_CONTENT_CHECKOUT_SUCCESS_PRODUCT_NOTIFICATIONS_TEXT_NOTIFY_PRODUCTS', '<strong>Bitte informieren Sie mich über Änderungen bei den von mir unten ausgewählten Produkten</strong>');
