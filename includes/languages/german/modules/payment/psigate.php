...
*/
  ...
  const MODULE_PAYMENT_PSIGATE_TEXT_DESCRIPTION = 'Credit Card Test Info:<br><br>CC#: 4111111111111111<br>Expiry: Any';
  ...
  const MODULE_PAYMENT_PSIGATE_TEXT_JS_CC_NUMBER = '* The credit card number must be at least %d characters.\n';
