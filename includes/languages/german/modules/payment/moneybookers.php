...
*/
  ...
  define('MODULE_PAYMENT_MONEYBOOKERS_TEXT_DESCRIPTION', '<img src="images/icon_popup.gif" border="0">&nbsp;<a href="http://www.moneybookers.com/partners/oscommerce" target="_blank" rel="noopener" style="text-decoration: underline; font-weight: bold;">Visit Moneybookers Website</a>' . $moneybookers_ping_button);
  ...
  define('MB_ACTIVATION_NONEXISTING_ACCOUNT_TEXT', 'The e-mail address is not a registered Moneybookers account. Please <a href="http://www.moneybookers.com/partners/oscommerce" target="_blank" rel="noopener">register here</a> to begin selling with Moneybookers.');
