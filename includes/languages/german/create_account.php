...
define('EMAIL_WARNING', '<strong>Achtung:</strong> Diese eMail-Adresse wurde uns von einem Kunden bekannt gegeben. Falls Sie sich nicht angemeldet haben, senden Sie bitte eine eMail an ' . STORE_OWNER_EMAIL_ADDRESS . '.' . "\n");

define('CATEGORY_COMPANY', 'Daten Ihrer Firma');
define('CATEGORY_PERSONAL', 'Ihre Daten');
define('CATEGORY_ADDRESS', 'Ihre Addresse');
define('CATEGORY_CONTACT', 'Ihre Kontaktinformationen');
define('CATEGORY_OPTIONS', 'Ihre Optionen');
